...
#save(DM_jaccard,file = "../data/beta_jaccard.RData")
```
...
load(file = "../data/beta_jaccard.RData")
temp_out = "../result/beta/"
```
...
wdat = merge(wpcoa$vectors[,1:2],meta_all, by.x = 0, by.y = "SampleID", all.x = T)  


## vegan::capscale
aa <- capscale(wdist ~ Sex + BodySite, data = wmeta)
