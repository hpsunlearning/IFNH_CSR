...
for(dd in c("uu","wu","bray","jaccard")){
  ...
  plot_timepoint_pcoa <- function(wdat, x_lab, y_lab){
    ggplot(wdat, aes(x = PC1, y = PC2, color = TimePoint)) + 
  ...
  ggsave(filename = paste0(temp_out,dd,"_","pup_by_timepoint_pcoa.pdf"), device = cairo_pdf, 
           plot = g, width = 7, height = 5, units = "in", dpi = 300)
  #PC1 by timepoint
  ...
  plot_birthmode_pcoa_timepoint <- function(wdat, x_lab, y_lab){
    ggplot(wdat, aes(x = PC1, y = PC2, color = BirthMode)) + 
      geom_point( size = 2) + 
      stat_ellipse(type = "t") + 
      scale_color_manual(values = BirthMode_color) + 
  ...
  g <- plot_birthmode_pcoa_timepoint(wdat_rda, x_lab, y_lab)   
  ggsave(filename = paste0(temp_out,dd,"_","pup_by_birthmode_timepoint_pcoa.pdf"), device = cairo_pdf, 
           plot = g, width = 7, height = 5, units = "in", dpi = 300)
  ##Poca sex
  ...
  plot_sex_pcoa_timepoint <- function(wdat, x_lab, y_lab){
    ggplot(wdat, aes(x = PC1, y = PC2, color = Sex)) + 
      geom_point( size = 2) + 
      stat_ellipse(type = "t") + 
      scale_color_manual(values = Sex_color, labels = Sex_labs) + 
  ...
  g <- plot_sex_pcoa_timepoint(wdat_rda, x_lab, y_lab)   
  ggsave(filename = paste0(temp_out,dd,"_","pup_by_sex_timepoint_pcoa.pdf"), device = cairo_pdf, 
           plot = g, width = 7, height = 5, units = "in", dpi = 300)
  ...
  ggsave(filename = paste0(temp_out,dd,"_","pup_by_timepoint_nmds.pdf"), device = cairo_pdf, 
           plot = g, width = 7, height = 5, units = "in", dpi = 300)  
  g <- plot_timepoint_pc1(wdat_nmds, x_lab)
  ggsave(filename = paste0(temp_out,dd,"_","pup_by_timepoint_nmds1.pdf"), device = cairo_pdf, 
           plot = g, width = 7, height = 5, units = "in", dpi = 300)
  g <- plot_timepoint_pc2(wdat_nmds, y_lab)
  ggsave(filename = paste0(temp_out,dd,"_","pup_by_timepoint_nmds2.pdf"), device = cairo_pdf, 
           plot = g, width = 7, height = 5, units = "in", dpi = 300)      
  ...
  ggsave(filename = paste0(temp_out,dd,"_","pup_by_birthmode_nmds.pdf"), device = cairo_pdf, 
           plot = g, width = 7, height = 5, units = "in", dpi = 300)
  g <- plot_birthmode_pcoa_timepoint(wdat_nmds, x_lab, y_lab)   
  ggsave(filename = paste0(temp_out,dd,"_","pup_by_birthmode_timepoint_nmds.pdf"), device = cairo_pdf, 
           plot = g, width = 7, height = 5, units = "in", dpi = 300)
  g <- plot_sex_pcoa(wdat_nmds, x_lab, y_lab) 
  ggsave(filename = paste0(temp_out,dd,"_","pup_by_sex_nmds.pdf"), device = cairo_pdf, 
           plot = g, width = 7, height = 5, units = "in", dpi = 300)  
  g <- plot_sex_pcoa_timepoint(wdat_nmds, x_lab, y_lab)   
  ggsave(filename = paste0(temp_out,dd,"_","pup_by_sex_timepoint_nmds.pdf"), device = cairo_pdf, 
           plot = g, width = 7, height = 5, units = "in", dpi = 300) 
}
```
...
## overweight
```{r}
wmeta <- meta_all %>% left_join(at_week15 %>% select(MouseID, BW_status, Overweight, Underweight), 
...
for(dd in c("uu","wu","bray","jaccard")){
  ...
  g <- ggplot(wdat_rda, aes(x = PC1, y = PC2, color = Overweight)) + 
      ...
      theme_bw() + theme(aspect.ratio = 1,
                           ...
                           legend.title = element_text(size=12,color="black",face='bold'),
                           title = element_text(size=12,color="black",face='bold'))
  ggsave(filename = paste0(temp_out,dd,"_","pup_Overweight_by_timepoint_pcoa.pdf"), device = cairo_pdf, 
           plot = g, width = 7, height = 5, units = "in", dpi = 300)
}
