...
column_ha = HeatmapAnnotation(df = df_col %>% dplyr::select(Age_group, BirthMode), 
                              col = list(Age_group = Age_group_color,
...
lgd1 = Legend(labels = c("Week3", "Week6", "Week9-14", "Week18"), title = "Age_group", 
              legend_gp = gpar(fill = Age_group_color),
...
#col annotation
df_col = meta %>% dplyr::select(Age_group, BirthMode, Sex)
column_ha = HeatmapAnnotation(df = df_col %>% dplyr::select( BirthMode,Age_group), 
                              col = list(Age_group = Age_group_color,
                                         BirthMode = BirthMode_color),
                              simple_anno_size = unit(6, "mm"), 
                              annotation_label = c("Time point", "BirthMode"),
